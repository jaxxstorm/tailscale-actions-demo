...
-- DECLARATIVE: Ensure exactly these products exist (6 SKUs including CI/CD)
-- Delete any products that shouldn't be here
DELETE FROM products WHERE name NOT IN ('Business VPN', 'Workload Connectivity', 'Edge & IoT', 'Securing AI', 'Homelab', 'CI/CD');
